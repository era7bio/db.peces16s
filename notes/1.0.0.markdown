[db.peces16s](https://github.com/ohnosequences/db.peces16s) is a comprehensive, compact, and automatically curated microbial 16S database, where each sequence is assigned to a set of NCBI taxonomy IDs.
